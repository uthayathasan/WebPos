...
namespace WebPos.DataAccess
{
    public class EposTransLineDA
    {
        ...
        public List<EposTransLine> GetTransLinesByELNo(string  connectionString,string CustomerId,string StoreId,string TillId, int ELNo)
        {
        ...
        public int UpdateTransLineByELNo(string  connectionString,string CustomerId,string StoreId,string TillId,EposTransLine m)
        {
            int result=0;
            string Sql="";
            #region SQL
            Sql +="Update "+CustomerId+"_"+StoreId+"_"+TillId+"_"+"EPOS_Trans_Line ";
            Sql +="set Amount=@Amount,Barcode=@Barcode,Bar_Print=@Bar_Print, ";
            Sql +="Bar_Printed=@Bar_Printed,Bar_Printed_Time=@Bar_Printed_Time,Department_Id=@Department_Id, ";
            Sql +="[Description]=@Description,Discount_Amount=@Discount_Amount,Discountable=@Discountable, ";
            Sql +="Discount_Percentage=@Discount_Percentage,Entry_Type=@Entry_Type, ";
            Sql +="Free_Text=@Free_Text,IsCharge=@IsCharge,IsChange=@IsChange, ";
            Sql +="IsModifier=@IsModifier,IsRefund=@IsRefund,Item_Group=@Item_Group, ";
            Sql +="Item_Sub_Group=@Item_Sub_Group,Kitchen_Print=@Kitchen_Print,Kitchen_Printed=@Kitchen_Printed, ";
            Sql +="Kitchen_Printed_Time=@Kitchen_Printed_Time,Line_No=@Line_No,Line_Status=@Line_Status, ";
            Sql +="LinkedOfferId=@LinkedOfferId,Main_Item_No=@Main_Item_No,Mandatory=@Mandatory, ";
            Sql +="Net_Amount=@Net_Amount,Number=@Number,OfferID=@OfferID, ";
            Sql +="OfferQuantity=@OfferQuantity,OfferTrigger=@OfferTrigger,OrderType=@OrderType, ";
            Sql +="Payment_Type=@Payment_Type,Price=@Price,Print_Group=@Print_Group, ";
            Sql +="Quantity=@Quantity,Scale=@Scale,Scanned=@Scanned, ";
            Sql +="Served=@Served,Split_Group=@Split_Group,Staff_Id=@Staff_Id, ";
            Sql +="Store_ID=@Store_ID,Temp_Item=@Temp_Item,Till_Id=@Till_Id, ";
            Sql +="Total_Cost=@Total_Cost,Trans_Date=@Trans_Date,Trans_ID=@Trans_ID, ";
            Sql +="Unit_Cost=@Unit_Cost,VAT_Amount=@VAT_Amount,VAT_Code=@VAT_Code, ";
         ...
         public int DeleteTransLineByELNO(string  connectionString,string CustomerId,string StoreId,string TillId,int Elno)
         {
            int result=0;
            string Sql="";
            #region SQL
            Sql +="delete "+CustomerId+"_"+StoreId+"_"+TillId+"_"+"EPOS_Trans_Line ";
            Sql +="where ELNo=@ELNo ";
            #endregion SQL
