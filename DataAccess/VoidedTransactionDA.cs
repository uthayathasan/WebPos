...
{
    public class VoidedTransactionDA
    {
         public int InsertVoidedTransaction(string connectionString,string CustomerId,string StoreId,VoidedTransaction m)
        {
            int result=0;
            string Sql="";
            #region SQL
            Sql +="insert into "+CustomerId+"_"+StoreId+"_"+"Voided_Transaction ";
            ...
            Sql +="Till_ID,Trans_Date,Trans_Type,TransactionText,Shift_Report_ID,Z_Report_ID) ";
            Sql +="values ";
            Sql +="(@Counter_Print,@Customer_Id,@Delivery_ID,@Floor,@Id, ";
            Sql +="@InfoItem,@Invoiced_Date,@InvoicePrinted,@Loyalty_Card,@Membership_No, ";
            Sql +="@Order_No,@Order_Type,@Order_Type_Text,@Seats,@Slip_No, ";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(Sql, connection))
                {
                    ...
                    #endregion Line 4
                    //@Till_ID,@Trans_Date,@Trans_Type,@TransactionText,@Shift_Report_ID,@Z_Report_ID
                    #region Line 5
                    #region @Till_ID
                    param  = new SqlParameter();
